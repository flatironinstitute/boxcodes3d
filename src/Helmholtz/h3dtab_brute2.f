...
c
c
      subroutine h3dtabp_ref_brute_fker(ndeg,tab,ldtab,fker,dpars,
     1  zpars,ipars)
...
C$OMP$SCHEDULE(DYNAMIC)
      do i=1,nbatches
        ...
        print *,i,ntt,istart,iend
        call ccubeints_adap(eps,norder,'t',npols,ntt,xyztmp(1,istart),
     1        ncmax,fker,dpars,zpars,ipars,nqorder,tab_t(1,istart))
        print *, "Finished batch# ", i
      enddo
C$OMP END PARALLEL DO
...
C$OMP$SCHEDULE(DYNAMIC)
      do i=1,nbatches
        ...
        print *, i,istart,iend,ntt
        call ccubeints_adap(eps,norder,'t',npols,ntt,xyztmp(1,istart),
     1        ncmax,fker,dpars,zpars,ipars,nqorder,tab_tmp(1,istart))
        print *, "finished batch #",i
      enddo
C$OMP END PARALLEL DO
...
c
c
      subroutine h3dtabp_ref_brute_new_fker(ndeg,tol,tab,ldtab,fker,
     1   dpars,zpars,ipars)
