...
c
c
      subroutine legetens_eval_3d_pq(p,ttype,q,coefs,nc,vals,nv,vmat)
c
...
c
      ...
      character *1 ttype
      real *8 coefs(nc),vals(q,q,q),vmat(p,q)
      real *8, allocatable :: ccv(:,:,:),cvv(:,:,:)
      real *8, allocatable :: coefs_cast(:,:,:)
